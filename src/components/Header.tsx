        ...
        <div className="flex justify-between items-center">
          ...
          <nav className={`absolute md:relative top-full left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none transition-all duration-300 ease-in-out transform ${isMenuOpen ? 'opacity-100 scale-y-100' : 'opacity-0 scale-y-0 pointer-events-none'} md:opacity-100 md:scale-y-100 md:pointer-events-auto origin-top ${isMenuOpen ? 'z-50' : '-z-10 md:z-auto'}`}>
            <ul className="flex flex-col md:flex-row items-center py-4 md:py-0 px-4 md:px-0 space-y-4 md:space-y-0 md:space-x-8">
              ...
              <li><a href="/services" className="text-gray-800 hover:text-blue-500 font-medium relative transition-colors duration-300 before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-0 hover:before:w-full before:h-0.5 before:bg-gradient-to-r before:from-blue-500 before:to-cyan-400 before:transition-all before:duration-300">Services</a></li>
              <li><a href="/portfolio" className="text-gray-800 hover:text-blue-500 font-medium relative transition-colors duration-300 before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-0 hover:before:w-full before:h-0.5 before:bg-gradient-to-r before:from-blue-500 before:to-cyan-400 before:transition-all before:duration-300">Portfolio</a></li>
